...
struct CardKnowledge {
    ...
    void setIsValuable(const SobBot &bot, const Hanabi::Server &server, bool knownValuable);
    void setIsWorthless(const SobBot &bot, const Hanabi::Server &server, bool knownWorthless);
    void update(const Hanabi::Server &server, const SobBot &bot, bool useMyEyesight);
...
class SobBot : public Hanabi::Bot {
  ...
  public:
    SobBot(int index, int numPlayers, int handSize, Hanabi::GameMode mode);
